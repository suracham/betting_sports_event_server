...
class TestFlaskApiUsingRequests(unittest.TestCase):
    ...
    def test_1_post_event_1(self):
        url = 'http://10.105.159.173:5000/api/match/createevent'
    ...
    def test_3_update_odds_event_1(self):
        url = 'http://10.105.159.173:5000/api/match/updateodds'
    ...
    def test_4_get_data_by_id(self):
        ...
        for id in [self.test_new_event['event']['id'], self.test_new_event_2['event']['id']]:
          url = 'http://10.105.159.173:5000/api/match/%s'%(id)
          data = urllib.urlencode(self.test_update_odds)
          req = urllib2.Request(url, data)
    ...
    def test_5_get_data_by_startTime(self):
        valid_res = '[\n  {\n    "id": 994839351840, \n    "name": "Cavaliers vs Lakers", \n    "startTime": "2018-01-15 22:00:00", \n    "url": "http://10.105.159.173:5000/api/match/994839351840"\n  }, \n  {\n    "id": 994839351740, \n    "name": "Real Madrid vs Barcelona", \n    "startTime": "2018-06-20 10:30:00", \n    "url": "http://10.105.159.173:5000/api/match/994839351740"\n  }\n]\n'
        url = 'http://10.105.159.173:5000/api/match?ordering=startTime'
        data = urllib.urlencode(self.test_update_odds)
        req = urllib2.Request(url, data)
        req.get_method = lambda: 'GET'
        response = urllib2.urlopen(req).read()
    ...
    def test_6_get_data_by_id(self):
        valid_res = '[\n  {\n    "id": 994839351740, \n    "name": "Real Madrid vs Barcelona", \n    "startTime": "2018-06-20 10:30:00", \n    "url": "http://10.105.159.173:5000/api/match/994839351740"\n  }, \n  {\n    "id": 994839351840, \n    "name": "Cavaliers vs Lakers", \n    "startTime": "2018-01-15 22:00:00", \n    "url": "http://10.105.159.173:5000/api/match/994839351840"\n  }\n]\n'
        url = 'http://10.105.159.173:5000/api/match?ordering=id'
        data = urllib.urlencode(self.test_update_odds)
        req = urllib2.Request(url, data)
        req.get_method = lambda: 'GET'
        response = urllib2.urlopen(req).read()
    ...
    def test_7_get_data_by_keys(self):
        valid_res = '[\n  {\n    "id": 994839351740, \n    "name": "Real Madrid vs Barcelona", \n    "startTime": "2018-06-20 10:30:00", \n    "url": "http://10.105.159.173:5000/api/match/994839351740"\n  }\n]\n'
        url = 'http://10.105.159.173:5000/api/match/?name=Real%20Madrid%20vs%20Barcelona'
        data = urllib.urlencode(self.test_update_odds)
        req = urllib2.Request(url, data)
        req.get_method = lambda: 'GET'
        response = urllib2.urlopen(req).read()
    ...
    def test_8_delete_event(self):
     # Delete Events
     for id in [self.test_new_event['event']['id'], self.test_new_event_2['event']['id']]:
       url = 'http://10.105.159.173:5000/api/match/deleteevent/%s'%(id)
